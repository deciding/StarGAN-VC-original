...
class Solver(object):
    ...
    def train(self):
        ...
        for i in range(start_iters, self.num_iters):
            ...
            out_src = self.D(x_hat, label_trg) # TODO:why label_trg not label_org
            d_loss_gp = self.gradient_penalty(out_src, x_hat)# TODO: suitable wgan-gp?
